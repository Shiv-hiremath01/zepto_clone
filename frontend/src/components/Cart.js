...
//   // Function to fetch the updated cart after modifications
//   const refreshCart = async () => {
//     try {
//       const response = await axios.get('http://localhost:5000/api/cart', {
//         headers: { Authorization: `Bearer ${user.token}` },
//       });
//       console.log('Updated cart data fetched:', response.data);
//       setCart(response.data);
//     } catch (error) {
...
//   // Handler for increasing the quantity of an item
...
//       await refreshCart(); // Refresh the cart after increasing quantity
//     } catch (error) {
//       console.error('Error increasing quantity:', error);
//     }
//   };

//   // Handler for decreasing the quantity of an item
...
//       await refreshCart(); // Refresh the cart after decreasing quantity
//     } catch (error) {
...
//       await refreshCart(); // Refresh the cart after clearing
//     } catch (error) {
